...
func Registerchannelremove(s *discordgo.Session, cmd *discordgo.InteractionCreate) {
	...
	succsess := xmldb.Xmlfileconfig_create(cmd.GuildID, GU, e1.AdminRoles, e1.AdminIGNs, e1.GuildMemberRolesIDs, e1.FriendsIngamename, e1.FriendRolesIDs, "", e1.RoleColour, e1.AllianceRoleColour)
