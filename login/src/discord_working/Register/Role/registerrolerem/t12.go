...
func Registered_roles_remove(s *discordgo.Session, cmd *discordgo.InteractionCreate) {
	...
	//e1.GuildMemberRolesIDs = append(e1.GuildMemberRolesIDs, RoleID)
	x := e1.GuildMemberRolesIDs

	e1.GuildMemberRolesIDs = []string{}

	for _, v := range x {
		if v != RoleID {
			e1.GuildMemberRolesIDs = append(e1.GuildMemberRolesIDs, v)
		}
	}
