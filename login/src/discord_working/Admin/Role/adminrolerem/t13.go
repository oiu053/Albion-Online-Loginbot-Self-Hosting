...
func Adminroles_remove(s *discordgo.Session, cmd *discordgo.InteractionCreate) {
	...
	e1.AdminRoles = []string{}

	for _, v := range x {
		if v != RoleID {
			e1.AdminRoles = append(e1.AdminRoles, v)
		}
	}
