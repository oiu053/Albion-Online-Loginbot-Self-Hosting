...
func Friends_roles_remove(s *discordgo.Session, cmd *discordgo.InteractionCreate) {
	...
	//e1.FriendRolesIDs = append(e1.FriendRolesIDs, RoleID)

	x := e1.FriendRolesIDs

	e1.FriendRolesIDs = []string{}

	for _, v := range x {
		if v != RoleID {
			e1.FriendRolesIDs = append(e1.FriendRolesIDs, v)
		}
	}
